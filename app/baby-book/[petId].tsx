...
const timeline = [
  { date: "Jan 2026", title: "Adopted from CarePaws", detail: "Welcome home check completed." },
  { date: "Feb 2026", title: "First vet visit", detail: "Healthy weight gain and clear appetite." },
  { date: "Mar 2026", title: "Rabies booster due", detail: "Reminder sent to adopter." },
];
    ...
    <SafeAreaView className="flex-1 bg-[#FDFAF4] dark:bg-gray-900">
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 24, paddingBottom: 90 }}>
        <View className="rounded-3xl bg-[#D4622A] p-5">
          <Text className="text-2xl font-extrabold text-white">Health timeline</Text>
          <Text className="mt-2 text-sm leading-5 text-white/90">Keep shelter and adopter records aligned after adoption.</Text>
        </View>
        ...
        <TouchableOpacity className="mt-6 rounded-2xl bg-[#D4622A] py-4">
          <Text className="text-center font-extrabold text-white">Report Health Update</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
