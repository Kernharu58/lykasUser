    ...
    <SafeAreaView className="flex-1 bg-bgSoft dark:bg-gray-900 items-center justify-center px-6">
      <View className="items-center">
        ...
        <Text className="text-center text-muted dark:text-gray-400 text-base mb-8">
          has been received. Every peso helps us care for animals waiting for
          their forever home. 🐾
        </Text>
        <TouchableOpacity
        ...
        >
          ...
          <View className="rounded-3xl bg-primary p-5 mb-6">
            ...
            <Text className="mt-2 text-white/80">
              Your donation helps us feed, shelter, and care for animals waiting
            ...
            {amounts.map((a) => (
              <TouchableOpacity
                ...
                className={`rounded-2xl px-5 py-3 ${
                  selectedAmount === a
                    ? "bg-primary"
                    : "bg-white border border-border dark:bg-gray-800"
                }`}
                onPress={() => {
                  setSelectedAmount(a);
                  setCustomAmount("");
          ...
          {/* ✅ Bug 3 fix — Goods donation entry point */}
          <TouchableOpacity
